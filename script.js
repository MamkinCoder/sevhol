...
function toastErrorColorChange() {
  document.getElementById("liveToast").className =
    "toast align-items-center text-bg-info text-light";
}
  ...
  entries.forEach((entry) => {
    if (entry.isIntersecting) {
      document
        ...
        .classList.add(targetActiveClass);
      document.querySelector(".callme").classList.add(targetActiveClass);
    } else {
      document
        .querySelector(".parallax_wrapper")
        .classList.remove(targetActiveClass);
...
var observer = new IntersectionObserver(callback, {
  root: document.querySelector(".parallax_wrapper"),
  threshold: 0,
  rootMargin: "0% 0px -50% 0px",
});
var navbar_observer = new IntersectionObserver(callback, {
  root: document.querySelector(".parallax_wrapper"),
  threshold: 0,
  rootMargin: "0px 0px -100% 0px",
});
var bgblur_observer = new IntersectionObserver(blur_bg, {
  root: document.querySelector(".parallax_wrapper"),
  threshold: 0,
  rootMargin: "0px 0px -50% 0px",
});
var bgblureasy_observer = new IntersectionObserver(blur_bg_easy, {
  root: document.querySelector(".parallax_wrapper"),
  threshold: 0,
  rootMargin: "0% 0px -50% 0px",
});
var footer_callme_remover = new IntersectionObserver(footer, {
  root: document.querySelector(".parallax_wrapper"),
  threshold: 0,
  rootMargin: "0% 0px 0% 0px",
});
var we_observer = new IntersectionObserver(callback, {
  root: document.querySelector(".parallax_wrapper"),
  threshold: 0,
