                    ...
                    <section class="container my-3">
                         <div class="row g-0">
                              <div class="col-xl col-lg p-3 card border-0 text-dark align-items-center rounded-start">
                                   <div class="card-body">
                                        <figure class="ms-2 w-50 float-end ">
                                             <div class="position-relative">
               ...
               <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                    <div class="modal-body">
                         ...
                         <div class="input-group mb-3">
                              <input type="text" autocomplete="name" placeholder="Николай Николаевич" name="name" aria-label="Name" class="form-control" required>
                         </div>
                         <label for="tel" class="form-label">Ваш номер телефона:</label>
                         <div class="input-group mb-3">
                              <span class="input-group-text" id="basic-addon1">+7</span>
                              <input class="formatted-phone" placeholder="123 456 78 90" type="tel" name="tel" required>
                         </div>
                         <label class="form-label" for="contactType">Способ связи:</label>
                         <div class="mb-3">
                              <div class="form-check form-check-inline">
                                   <input class="form-check-input" type="radio" name="contactType" value="whatsapp" id="radio_whatsapp" value="whatsapp" checked>
                                   <label class="form-check-label" for="radio_whatsapp">
                                        <img class="icon" src="img/WhatsApp.svg" /> WhatsApp
                                   </label>
                              </div>
                              <div class="form-check form-check-inline">
                                   <input class="form-check-input" type="radio" name="contactType" value="telegram" id="radio_telegram" value="telegram">
                                   <label class="form-check-label" for="radio_telegram">
                                        <img class="icon" src="img/Telegram.svg" /> Telegram
                                   </label>
                              </div>
                              <div class="form-check form-check-inline">
                                   <input class="form-check-input" type="radio" name="contactType" value="phone" id="radio_phone" value="phone">
                                   <label class="form-check-label" for="radio_phone">
                                        <img class="icon" src="img/phone.svg" /> Мобильный
                                   </label>
                              </div>
                         </div>
                    ...
                    <div class="modal-footer">
                         <div class=" d-flex flex-sm-row align-content-end"><small class = "quet">Нажимая “Отправить”, Вы соглашаетесь с <a href="url">политикой обработки персональных данных</a>.</small>
...
<footer class="d-flex flex-sm-row justify-content-between align-items-center py-3 my-4 border-top">
     <div class="d-flex align-items-center">
          ...
          <span class="ms-2">© 2023 год "СевХолСервис" <br> powered by <a href="https://getbootstrap.com"><svg id="b-icon" class="icon footer-shine"><use xlink:href="#bootstrap-outline"></use></svg></a>
     </span>
</div>
<ul class="nav justify-content-end list-unstyled d-flex">
     <li class="mx-2"><a href="#"><svg class="icon footer-shine"><use xlink:href="#whatsapp-outline"></use></svg></a></li>
     <li class="mx-2"><a href="#"><svg class="icon footer-shine"><use xlink:href="#telegram-outline"></use></svg></a></li>
     <!-- TODO -->
     <li class="ms-2"><a href="mailto:skv@ngs.ru"><svg class="icon footer-shine" width="30" height="30"><use xlink:href="#envelope"></use></svg></a></li>
</ul>
</footer>
</div>
